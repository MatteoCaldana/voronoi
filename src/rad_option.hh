...
class radius_mono {
	protected:
		...
		inline double r_current_sub(double rs,int ,int ) {return rs;}
		...
		inline double r_scale(double rs,int ,int ) {return rs;}
		 ...
		 * otherwise. */
		inline bool r_scale_check(double &rs,double mrs,int ,int ) {return rs<mrs;}
};
